...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Stevin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Creating Wonderful', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://stevin.cc', // 网站地址
